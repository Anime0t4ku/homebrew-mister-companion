cask "mister-companion-unstable-nightly" do
  ...
  installer script: {
    ...
    args:         [
      ...
      <<~EOS
        ...
        #!/bin/bash
        exec open -a "/Applications/MiSTer Companion Unstable Nightly.app" --args "$@"
        EOF
            ...
            <dict>
              ...
              <key>CFBundleVersion</key><string>nightly</string>
  ...
  app "MiSTer Companion Unstable Nightly.app"

  postflight do
    system_command "/System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister",
                   args: ["-f", appdir/"MiSTer Companion Unstable Nightly.app"]
  end
